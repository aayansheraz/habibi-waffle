...
> = {
  chinese: {
    ...
    logo: import.meta.env.BASE_URL + "images/logo-habibi-light.webp",
  ...
  waffle: {
    ...
    logo: import.meta.env.BASE_URL + "images/logo-waffle.webp",
  ...
  fastfood: {
    ...
    accent: "text-white/80",
    logo: import.meta.env.BASE_URL + "images/logo-h.webp",
